//
//  ERCheeseToWineViewController.m
//  Estheryan
//
...
@interface ERCheeseToWineViewController ()

@end

@implementation ERCheeseToWineViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text = [self.wines objectAtIndex:section];
